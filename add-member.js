...
//showing big cards body
$(".toggler").click(function (){
$("."+$(this).data("target")).slideToggle(500);
$(this).toggleClass("fa-chevron-up","fa-chevron-down");
});
//making the chekboxes inversly
$(".empyloyment-body .chek").click(function (){
 if($($(this).data("check")).is(':checked')){
$($(this).data("check")).prop("checked",false);
 }
});
});